...
export interface RemittanceOrder {
  ...
  municipality: string;
  createdAt: string;
  paymentStatus: 'pending_wallet' | 'awaiting_payment' | 'detected' | 'underpaid' | 'payment_review' | 'confirmed' | 'notified' | 'swept' | 'ready_for_delivery' | 'delivered' | 'cancelled' | 'expired' | 'contact_whatsapp';
  paymentMethod: PaymentMethod;
